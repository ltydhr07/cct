...
const HomePage = () => {
  ...
  return (
    <StyledWapper className="flex flex-col items-center pt-0 sm:pt-[54px]">
      <div className="hidden sm:flex fixed left-0 top-0 items-center w-full h-[54px] pl-6 sm:pl-4 bg-white">
        <img className="w-[91px] cursor-pointer" src={logo_pc} alt="" onClick={() => toHome()} />
      </div>
